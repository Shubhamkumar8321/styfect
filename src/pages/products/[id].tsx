...
//               <div className="w-68 h-40 sm:w-48 sm:h-48 overflow-hidden relative">
//                 <Image
...
//             ★★★★☆ 4.8 (3,166 Reviews)
//           </p>
//           <p className="text-base lg:text-lg leading-relaxed mt-4 px-4">
...
//                       <div className="w-60 h-40 sm:w-48 sm:h-48 overflow-hidden relative">
//                         <Image
...
//               {relatedProducts.slice(0, 4).map((p) => (
//                 <Link key={p.id} href={`/products/${p.id}`}>
//                   <div className="group relative bg-[#fff]  overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border-gray-200 hover:border-gray-400 hover:bg-gray-100">
...
//                       <div className="w-44 h-44 sm:w-52 sm:h-52 md:w-64 md:h-64  overflow-hidden relative">
//                         <Image
//                           src={p.images?.[0]?.src || "/placeholder.jpg"}
//                           alt={p.name}
//                           fill
...
//       const totalWidth =
//         scaleWidthRef.current.scrollWidth - scaleWidthRef.current.clientWidth;
...
//       const totalWidth =
//         scaleHeightRef.current.scrollWidth - scaleHeightRef.current.clientWidth;
//       const value = Math.round(50 + (150 * scrollPos) / totalWidth);
//       setHeight(value);
//     }
//   };
    ...
    <div className="bg-gray-50 min-h-screen py-4 sm:px-8 lg:px-16">
      ...
      <div className="lg:hidden -mt-6">
        ...
        <div className="lg:hidden -mt-6">
          <div className="shadow-md space-y-3 bg-[#dadada]">
            {/* Mobile Main Image */}
            <div className="relative w-full flex items-center justify-center bg-[#dadada]">
              <div className="group relative w-full h-72 sm:h-80 bg-white rounded-br-[60%] flex items-center justify-center border-2 border-gray-200 overflow-hidden shadow-md hover:shadow-xl hover:border-gray-400 transition">
                <Image
                  src={getSafeImage(images[selectedImage])}
                  alt={product.name}
                  fill
          ...
          <div className="mt-14 p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {relatedProducts.slice(0, 4).map((p) => (
                <Link key={p.id} href={`/products/${p.id}`}>
                  <div className="group relative bg-[#fff] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border-2 border-gray-200 hover:border-gray-400 hover:bg-gray-100">
                    <div className="relative w-full h-56 sm:h-64 bg-[#dadada] rounded-br-[60%] flex items-center justify-center overflow-hidden border-2 border-gray-200 hover:border-gray-400">
                      <Image
                        src={p.images?.[0]?.src || "/placeholder.jpg"}
                        alt={p.name}
                        fill
          ...
          <div className="mt-14 p-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
              {relatedProducts.slice(0, 4).map((p) => (
                <Link key={p.id} href={`/products/${p.id}`}>
                  <div className="group relative bg-[#fff] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border-2 border-gray-200 hover:border-gray-400 hover:bg-gray-100">
                    <div className="relative w-full h-64 md:h-72 bg-[#dadada] rounded-br-[60%] flex items-center justify-center overflow-hidden border-2 border-gray-200 hover:border-gray-400">
                      <Image
                        src={p.images?.[0]?.src || "/placeholder.jpg"}
                        alt={p.name}
                        fill
